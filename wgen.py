...
for domain in domains:
    ...
    cmd= (f"gospider -s {domain}  | egrep -o '{domain}.*$'| egrep -v '(\.png|\.css|\.svg|\.js|\.gif|\.jpg|\?)'|sort -u |tee -a file.txt; echo {domain} >>file.txt").replace('\r', '').replace('\n', '')
